      ...
      <div className='bg-long bg-partners'/>
        {cardData.map(el=>(
            <div className="partners-card dark-blue" style={{width:`${el.width}%`}}>
              <img src={el.bg} alt={el.title} style={{width:`${el.imgW}%`}}/>
              <h4>{t(el.title)}</h4>
              <p>{el.info}</p>
